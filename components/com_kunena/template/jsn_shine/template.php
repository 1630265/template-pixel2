 ...
 * @since  K4.0
 */
class KunenaTemplateJSN_Shine extends KunenaTemplate
{
	/**
	 ...
	 * @var array
	 */
	protected $default = array('jsn_shine');
	...
	public function loadLanguage()
	{
		...
		KunenaFactory::loadLanguage('kunena_tmpl_jsn_shine');

		foreach (array_reverse($this->default) as $template)
		{
			$file = "kunena_tmpl_jsn_shine";
	...
	public function initialize()
	{
		...
		$this->compileLess('assets/less/kunena.less', 'kunena.css');
		$this->addStyleSheet('kunena.css');

		$filenameless = JPATH_SITE . '/components/com_kunena/template/jsn_shine/assets/less/custom.less';
		...
		$filename = JPATH_SITE . '/components/com_kunena/template/jsn_shine/assets/css/custom.css';
