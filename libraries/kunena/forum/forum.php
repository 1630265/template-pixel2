...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		if ('5.0.10' == '@' . 'kunenaversion' . '@')
		{
			...
			{
				self::$version = strtoupper('5.0.10');
			}
		}
		else
		{
		...
		self::$version_date = ('2017-06-30' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2017-06-30';
		self::$version_name = ('Junco' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Junco';
	}
}
