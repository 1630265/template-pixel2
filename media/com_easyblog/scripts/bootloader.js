...
// Setup foundry
FD50.setup({
	"environment": window.eb.environment,
	"source": "local",
	"mode": window.eb.environment == "production" ? "compressed" : "uncompressed",
	"path": window.eb.rootUrl + "/media/com_easyblog/scripts/vendors",
	"cdn": "",
	"extension":".js",
	"cdnPath": "",
	"rootPath": window.eb.rootUrl,
	"basePath": window.eb.rootUrl,
	"indexUrl": window.eb.rootUrl + '/index.php',
	"token": window.eb.token,
	"locale":{
		"lang": window.eb.locale
	}
});
...
FD50.component("EasyBlog", {
	...
	"mode": window.eb.environment == "production" ? "compressed" : "uncompressed",
	"mode": "compressed",
	"baseUrl": window.eb.baseUrl,
	"version":"2.0",
	"momentLang": window.eb.momentLang,
	"ajaxUrl": window.eb.ajaxUrl
});
