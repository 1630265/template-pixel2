...
},"{self} onClearForm":function(c,d,e,f,g){"link"==f&&(a(g).find(b.title.selector).val(""),a(g).find(b.content.selector).val(""),a(g).find(b.link.selector).val(""),a(g).find(b.tags.selector).val(""),b.preview().addClass("hide"))}}}),b.resolve()}),EasyBlog.module("site/dashboard/quickpost/photo",function(){var b=this;EasyBlog.require().library("plupload2").script("site/vendors/webcam").done(function(a){EasyBlog.Controller("Quickpost.Form.Photo",{defaultOptions:{"{capture}":"[data-photo-camera-capture]","{canvas}":"[data-photo-camera-canvas]","{preview}":"[data-photo-camera-preview]","{recapture}":"[data-photo-camera-recapture]",dataType:"upload","{tabs}":"[data-quickpost-photo-tab]","{tabUpload}":"[data-quickpost-photo-tab-upload]","{tabWebcam}":"[data-quickpost-photo-tab-webcam]","{uri}":"[data-photo-uri]","{container}":"[data-photo-upload-container]","{uploadPreview}":"[data-photo-upload-preview]","{reupload}":"[data-photo-upload-reupload]","{form}":"[data-microblog-form]","{link}":"[data-quickpost-link]","{title}":"[data-quickpost-title]","{content}":"[data-quickpost-content]","{tags}":"[data-quickpost-tags]","{privacy}":"[data-quickpost-privacy]","{category}":"[data-quickpost-category]"}},function(b,c,d){return{init:function(){b.registerUploader(),b.hasFlash()||a("ul.eb-quick-photo-tab").hide()
},registerUploader:function(){d=b.container().plupload2({},!1),d.bind("FilesAdded",function(){d.start()}),d.bind("FileUploaded",function(c,d,e){var f=JSON.parse(e.response),g=f.media,h=new Image;a(h).attr("src",g.meta.url),b.uri().val(g.uri),b.container().addClass("hidden"),b.uploadPreview().removeClass("hidden").append(h),b.reupload().removeClass("hidden")})},hasFlash:function(){var a=!1;try{var b=new ActiveXObject("ShockwaveFlash.ShockwaveFlash");b&&(a=!0)}catch(c){navigator.mimeTypes&&void 0!=navigator.mimeTypes["application/x-shockwave-flash"]&&navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin&&(a=!0)
}return a},"{reupload} click":function(){b.reupload().addClass("hidden"),b.container().removeClass("hidden"),b.uploadPreview().addClass("hidden").html("")},"{tabs} click":function(c){b.options.dataType=a(c).data("type"),"photo"==b.options.dataType&&(console.log("init uploader"),d.init())},webcamStarted:!1,"{capture} click":function(){webcam.capture()},"{recapture} click":function(){b.capture().removeClass("hidden"),b.recapture().addClass("hidden"),b.canvas().removeClass("hidden"),b.preview().find("img").remove(),b.preview().addClass("hidden")
},"{tabWebcam} click":function(){var e=0,f=null,h=[],i=b.canvas().data("key"),j=document.createElement("canvas");j.setAttribute("width",320),j.setAttribute("height",240),j.toDataURL?(f=j.getContext("2d"),h=f.getImageData(0,0,320,240),saveCallback=function(c){for(var d=c.split(";"),g=h,k=0;320>k;k++){var l=parseInt(d[k]);g.data[e+0]=l>>16&255,g.data[e+1]=l>>8&255,g.data[e+2]=255&l,g.data[e+3]=255,e+=4}e>=307200&&(f.putImageData(g,0,0),EasyBlog.ajax("site/controllers/quickpost/saveWebcam",{key:i,type:"data",image:j.toDataURL("image/png")}).done(function(c){var d=c.url,e=new Image;
b.preview().removeClass("hidden"),a(e).attr("src",d).appendTo(b.preview()),b.canvas().addClass("hidden"),b.capture().addClass("hidden"),b.recapture().removeClass("hidden"),b.uri().val(c.uri)}),e=0)}):saveCallback=function(b){h.push(b),e+=1280,e>=307200&&(a.post("/upload.php",{type:"pixel",image:h.join("|")}),e=0)},b.webcamStarted||(b.canvas().webcam({width:320,height:240,mode:"callback",swffile:a.basePath+"/media/com_easyblog/scripts/site/vendors/jscam.swf",onSave:saveCallback,onCapture:function(){webcam.save()
}}),b.webcamStarted=!0)},uploaderInitialized:!1,"{self} onTabChange":function(){b.uploaderInitialized||d.init()},"{self} onPublishQuickPost":function(c,d,e,f,g){"photo"==f&&(e.data={dataType:b.options.dataType,title:a(g).find(b.title.selector).val(),type:"photo",content:a(g).find(b.content.selector).val(),link:a(g).find(b.link.selector).val(),tags:a(g).find(b.tags.selector).val(),privacy:a(g).find(b.privacy.selector).val(),category:a(g).find(b.category.selector).val(),uri:b.uri().val()})},"{self} onClearForm":function(c,d,e,f,g){"photo"==f&&(a(g).find(b.title.selector).val(""),a(g).find(b.content.selector).val(""),a(g).find(b.link.selector).val(""),a(g).find(b.tags.selector).val(""),b.uri().val(""),b.reupload().addClass("hidden"),b.container().removeClass("hidden"),b.uploadPreview().addClass("hidden").html(""))
}}}),b.resolve()})}),EasyBlog.module("site/dashboard/quickpost/quote",function(a){var b=this;EasyBlog.Controller("Quickpost.Form.Quote",{defaultOptions:{"{quote}":"[data-quickpost-content]","{content}":"[data-quickpost-source]","{tags}":"[data-quickpost-tags]","{privacy}":"[data-quickpost-privacy]","{category}":"[data-quickpost-category]"}},function(b){return{"{self} onPublishQuickPost":function(c,d,e,f,g){"quote"==f&&(e.data={quote:a(g).find(b.quote).val(),type:"quote",source:a(g).find(b.content).val(),tags:a(g).find(b.tags).val(),privacy:a(g).find(b.privacy).val(),category:a(g).find(b.category).val()})
},"{self} onClearForm":function(c,d,e,f,g){"quote"==f&&(a(g).find(b.quote).val(""),a(g).find(b.content.selector).val(""),a(g).find(b.tags.selector).val(""))}}}),b.resolve()}),EasyBlog.module("site/dashboard/quickpost/standard",function(a){var b=this;EasyBlog.Controller("Quickpost.Form.Standard",{defaultOptions:{"{title}":"[data-quickpost-title]","{content}":"[data-quickpost-content]","{tags}":"[data-quickpost-tags]","{privacy}":"[data-quickpost-privacy]","{category}":"[data-quickpost-category]"}},function(b){return{"{self} onPublishQuickPost":function(c,d,e,f,g){"standard"==f&&(e.data={title:a(g).find(b.title).val(),type:"text",content:a(g).find(b.content).val(),tags:a(g).find(b.tags).val(),privacy:a(g).find(b.privacy).val(),category:a(g).find(b.category).val()})
},"{self} onClearForm":function(c,d,e,f,g){"standard"==f&&(a(g).find(b.title.selector).val(""),a(g).find(b.content.selector).val(""),a(g).find(b.tags.selector).val(""))}}}),b.resolve()}),EasyBlog.module("site/dashboard/quickpost/video",function(a){var b=this;EasyBlog.Controller("Quickpost.Form.Video",{defaultOptions:{"{form}":"[data-microblog-form]","{loader}":"[data-quickpost-video-loader]","{getVideo}":"[data-quickpost-video-retrieve]","{title}":"[data-quickpost-video-title]","{content}":"[data-quickpost-video-source]","{tags}":"[data-quickpost-tags]","{privacy}":"[data-quickpost-privacy]","{category}":"[data-quickpost-category]","{preview}":"[data-quickpost-video-preview]"}},function(b){return{"{getVideo} click":function(a,c){c.preventDefault(),b.loader().removeClass("hidden"),EasyBlog.ajax("site/views/quickpost/getVideo",{link:b.content().val()}).done(function(a){b.loader().addClass("hidden"),b.preview().addClass("has-preview"),b.preview().html(a)
...
EasyBlog.ajax("site/controllers/teamblogs/setAdmin",{id:f,teamId:c.teamId}).done(function(){a(b).addClass("hide"),e.find("[data-remove-admin]").removeClass("hide"),e.find("[data-member-is-admin]").removeClass("hide")})},"{removeAdmin} click":function(b){var e=a(b).parents("[data-team-member]"),f=e.data("id");EasyBlog.ajax("site/controllers/teamblogs/removeAdmin",{id:f,teamId:c.teamId}).done(function(){a(b).addClass("hide"),e.find("[data-set-admin]").removeClass("hide"),e.find("[data-member-is-admin]").addClass("hide")
})}}}),b.resolve()}),EasyBlog.module("featured",function(a){var b=this;EasyBlog.require().done(function(){EasyBlog.Controller("Featured.Scroller",{defaultOptions:{elements:null,itemWidth:null,autorotate:{enabled:!1,interval:50},"{placeHolder}":".slider-holder","{slider}":".featured-entries","{sliderItems}":".slider-holder ul li","{sliderNavigation}":".featured-navi .featured-a a"}},function(b){return{init:function(){b.options.itemWidth=b.placeHolder().width()+1;var a=b.sliderItems().length*parseInt(b.options.itemWidth);
...
b.sliderNavigation().each(function(){a(this).hasClass("active")&&1!=c&&(0==a(this).next().length?b.nextItem(b.sliderNavigation(":first")):b.nextItem(a(this).next()),c=!0)}),setTimeout(function(){b.initAutoRotate()},1e3*parseInt(b.options.autorotate.interval))}}}),b.resolve()})}),EasyBlog.module("site/layout/image/legacy",function(a){function c(a){var b=a.parent(),c=b.css("float");if("none"==c&&(c=a.css("float")),"none"==c){var d=a[0].style;"auto"==d.marginLeft&&"auto"==d.marginRight&&(c="center")}return"none"==c&&(c=b.attr("align"),(void 0===c||"none"==c)&&(c=a.attr("align"))),/none|middle/.test(c)&&(c="center"),c
...
}}})},"{viewMemberBtn} click":function(){console.log(a.options.id),EasyBlog.dialog({content:EasyBlog.ajax("site/views/teamblog/viewMembers",{id:a.options.id}),bindings:{"{closeButton} click":function(){EasyBlog.dialog().close()}}})}}}),b.resolve()})}),EasyBlog.module("site/vendors/markitup",function($){var module=this;!function($){$.fn.markItUp=function(settings,extraSettings){var method,params,options,ctrlKey,shiftKey,altKey;return ctrlKey=shiftKey=altKey=!1,"string"==typeof settings&&(method=settings,params=extraSettings),options={id:"",nameSpace:"",root:"",previewHandler:!1,previewInWindow:"",previewInElement:"",previewAutoRefresh:!0,previewPosition:"after",previewTemplatePath:"~/templates/preview.html",previewParser:!1,previewParserPath:"",previewParserVar:"data",resizeHandle:!0,beforeInsert:"",afterInsert:"",onEnter:{},onShiftEnter:{},onCtrlEnter:{},onTab:{},markupSet:[{}]},$.extend(options,settings,$.markItUp.sets[(extraSettings||settings||{}).set],extraSettings),options.root||$("script").each(function(a,b){miuScript=$(b).get(0).src.match(/(.*)jquery\.markitup(\.pack)?\.js$/),null!==miuScript&&(options.root=miuScript[1])
