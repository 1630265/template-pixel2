...
}}}("FD50"),FD50.setup({environment:window.eb.environment,source:"local",mode:"production"==window.eb.environment?"compressed":"uncompressed",path:window.eb.rootUrl+"/media/com_easyblog/scripts/vendors",cdn:"",extension:".js",cdnPath:"",rootPath:window.eb.rootUrl,basePath:window.eb.rootUrl,indexUrl:window.eb.rootUrl+"/index.php",token:window.eb.token,locale:{lang:window.eb.locale}}),FD50.component("EasyBlog",{environment:window.eb.environment,source:"local",mode:"production"==window.eb.environment?"compressed":"uncompressed",mode:"compressed",baseUrl:window.eb.baseUrl,version:"2.0",momentLang:window.eb.momentLang,ajaxUrl:window.eb.ajaxUrl}),jQuery.version="5.0",jQuery.long_version="5.0.10";
...
},getBlock:function(a){var b=q.find(EBD.block+"[data-uid="+a+"]");return b},getBlockUid:function(a){return a.attr("data-uid")||b.setBlockUid(a)},setBlockUid:function(b){return b.attr("data-uid")||function(){var c=a.uid();return b.attr("data-uid",c),c}()},updateBlockUid:function(a){a.removeAttr("data-uid"),b.setBlockUid(a)},getBlockType:function(b){return a(b).attr("data-type")},metas:{},getBlockMeta:function(c){return c instanceof a&&(c=b.getBlockType(c)),b.metas[c]||function(){var a=b.meta().where("type",c).val();
...
else{var i=blocks.getBlockContent(a);h.editableHtml=i.html()}return b.trigger("composerBlockExport",[a,h]),h},addBlock:function(a){b.root().append(a),b.initBlock(a)},removeBlock:function(c){b.trigger("composerBlockBeforeRemove",[c]),c.find(EBD.nestedBlock).each(function(){var c=a(this);b.removeBlock(c)}),c.remove(),b.trigger("composerBlockRemove",[c])},scrollTo:function(a){var b=r.viewport();r.viewportContent().stop(!0).scrollTo(a,500,{axis:"y",offset:{top:(b.height()-a.height())/-2,left:0}})},blockHandlers:{},loadBlockHandler:a.memoize(function(c){if(!c)return a.Deferred().reject(a.Exception("Invalid block type given."));
...
},getMechanics:function(){return r.settings.get("blocks.mechanics")},setMechanics:function(a){r.settings.set("blocks.mechanics",a),b.trigger("composerBlockMechanicsChange",a)},"{mechswitch} click":function(a){b.mechswitch().removeClass("btn-primary"),a.addClass("btn-primary"),b.setMechanics(a.attr("data-value"))},"{block} mouseover":function(a,c){c.hovered||(c.hovered=!0,b.trigger("composerBlockHoverIn",[a]))},"{block} mouseout":function(a){b.trigger("composerBlockHoverOut",[a])},"{self} composerDocumentInit":function(){var c=b.getAllBlocks();
c.each(function(){var c=a(this);b.initBlock(c)})},"{self} composerDocumentBlur":function(){return b.refocusing?(b.refocusing=!1,void 0):(b.deactivateBlock(),void 0)},"{self} click":function(c,d){var e=b.view().parent().hasClass("open");if(e){var f=a(d.target);f.is("[data-toolbar-blocks]")||f.parents("[data-eb-composer-blocks]").length>0||b.view().parent().removeClass("open")}},"{self} keyup":function(a,c){var d=b.view().parent().hasClass("open");d&&27==c.keyCode&&b.view().parent().removeClass("open")},"{editableContent} focusin":function(a,c){c.focusHandled||b.refocusing||r.document.isLegacy()||(b.refocusing=!0,c.focusHandled=!0,setTimeout(function(){var c=(b.workarea(),r.editor.selection.get()),d=c.focusNode;
...
},"{self} composerBlockDuplicate":function(a,c,d){b.selectedBlock=d},"{self} composerBlockMenuSelected":function(a,c,d){b.selectedBlock=d},"{self} composerBlockInit":function(c,d,e){var g=f.getBlockType(e);if("image"==g){var h=a.extend(!0,{},b.draggableOptions,{cursorAt:{top:0,left:0}});return e.draggable(h),void 0}e.draggable(b.draggableOptions)},populateDropzones:function(){b.nest().each(function(){var c=a(this),d=c.data("type");if("block"==d&&(c.prepend(b.createNestedDropzone()),c.find(EBD.childBlock).each(function(){var c=a(this);
c.after(b.createNestedDropzone())})),"content"==d){var e=f.nestable.availablePositions(c);a.each(e,function(a,d){c.prepend(b.createNestedDropzone(d))})}});var c=f.getRootBlocks();c.each(function(c){var d=a(this);0==c&&d.before(b.createDropzone()),d.hasClass("is-sort-item")||d.after(b.createDropzone())}),c.length<1&&b.root().append(b.createDropzone()),b.dropzone().droppable(b.droppableOptions)},createDropzone:function(){return a(b.dropzonePlaceholder).clone()},createNestedDropzone:function(a){var c=b.createDropzone().addClass("is-nested");
return a&&c.addClass("nest-"+a).data("position",a),c},destroyDropzones:function(){b.dropzone().remove()},"{block} dragstart":function(a,c,d){c.stopPropagation(),d.helper.addClass("is-helper").css({width:a.width(),height:a.height()}),f.deactivateBlock(),f.drag(a),a.addClass("hide"),g=a,b.populateDropzones(),e.manager().addClass("is-resizing")},"{blocks.menu} dragstart":function(a){b.populateDropzones(),g=a,e.manager().addClass("is-resizing")},"{mediaFile} dragstart":function(){b.populateDropzones(),g=a(),e.manager().addClass("is-resizing")
},"{dropzone} click":function(a){if(!e.manager().hasClass("is-dragging-block")){b.isDropping=!0;var d=b.selectedBlock;d.removeClass("hide").removeClass("is-sort-item"),b.dropBlock(a,d),setTimeout(function(){b.isDropping=!1,b.dropStop(),b.selectedMenu=null,b.selectedBlock=null,e.manager().removeClass("is-dropping-block"),e.manager().removeClass("is-moving-block")},0)}},"{dropzone} mouseenter":function(a){a.addClass("is-receiving")},"{dropzone} mouseleave":function(a){a.removeClass("is-receiving")},"{dropzone} dropover":function(a,c,d){f.over(a),b.lastDropzone=a;
var e=a.data("position");d.helper.addClass("is-sending"),e&&b.nest.of(a).data("snappedPosition",e)},"{dropzone} dropout":function(a,c,d){b.lastDropzone=null,f.out(a),d.helper.removeClass("is-sending")},isDropping:!1,lastDropzone:null,dropBlock:function(a,c){var d=c,g=c.is(f.menu);g&&(d=f.createBlockFromMenu(c));var h=c.is(b.mediaFile);h&&(d=f.createBlockFromMediaFile(c));var i=e.manager().hasClass("is-moving-block"),j=e.manager().hasClass("is-dropping-block"),k=e.manager().hasClass("is-duplicating-block");if(i||j){var l=f.getBlockNest(a),m=a.data("position");
l.data("snappedPosition",m)}a.replaceWith(d),(g||h||i||j||k)&&(f.drop(d),f.release(d),f.out(d))},dropStop:function(){setTimeout(function(){b.destroyDropzones()},1),e.manager().removeClass("is-resizing")},"{dropzone} drop":function(a,c,d){if(!b.isDropping){b.isDropping=!0;var e=d.draggable;b.dropBlock(a,e),setTimeout(function(){b.isDropping=!1},0)}},"{block} dragstop":function(a){a.removeClass("hide"),f.drop(a),f.release(a),f.out(a),b.dropStop()},"{blocks.menu} dragstop":function(a,c,d){if(b.isDropping||!b.lastDropzone)return b.dropStop(),void 0;
var e=d.helper;b.dropBlock(b.lastDropzone,e),b.dropStop()},"{mediaFile} dragstop":function(a,c,d){if(b.isDropping||!b.lastDropzone)return b.dropStop(),void 0;var e=d.helper;b.dropBlock(b.lastDropzone,e),b.dropStop()},"{self} composerDocumentScroll":function(b,c){var d=g.data("ui-draggable");a.ui.ddmanager.prepareOffsets(d,c)},"{dropzone} dropdeactivate":function(a){f.out(a)}}}),b.resolve()})}),EasyBlog.module("composer/blocks/font",function(a){var b=this;EasyBlog.require().script("composer/vendors/colorpicker","composer/vendors/nouislider").done(function(){EasyBlog.Controller("Composer.Blocks.Font",{elements:[".eb-composer-fieldset[data-name=font] [data-eb-{font-color-menu|font-family-menu|font-size-menu|font-color-content|font-color-picker|font-family-content|font-size-content|font-color-caption|font-family-caption|font-size-caption|font-family-option|font-format-option}]",".eb-composer-fieldset[data-name=font] [data-eb-{numslider-toggle|numslider-widget|numslider-value|numslider-input|numslider-units|numslider-unit|numslider-current-unit}]",".eb-composer-fieldset[data-name=font] [data-eb-{colorpicker|colorpicker-toggle}]"],defaultOptions:a.extend({fontSizeUnits:{px:{start:12,step:2,range:{min:8,max:72},pips:{mode:"values",density:4,values:[8,12,18,24,48,72]}},"%":{start:100,step:10,range:{min:0,max:200},pips:{mode:"positions",values:[0,50,100],density:10}}}},EBD.selectors)},function(b,c,d,e,f,g){return{init:function(){f=b.blocks,e=f.composer,g=a(),b.initFontFormatting(),b.initFontColor()
...
}),e},toLegacyHTML:function(b){var d=a("<a>").attr({href:b.url}).html(b.title);return d.prop("outerHTML")},activate:function(a){h=a,b.populate(a)},deactivate:function(){},construct:function(b){var c=f.createBlockContainer("file"),b=a.extend(f.data(c),b);return c},reconstruct:function(a){var c=f.data(a),d=b.placeholder.inside(a),e=b.dropElement.inside(d);c.url&&b.createPreview(a,c.url,c.name,c.type,c.size),e.length>0&&EasyBlog.MediaManager.uploader.register(d)},deconstruct:function(a){var c=f.getBlockContent(a);
return b.fileName.inside(c).editable(!1),a},refocus:function(){},reset:function(){},populate:function(a){var c=f.data(a),d=1==c.showicon?1:0,e=1==c.showsize?1:0;b.showIcon().val(d).trigger("change"),b.showSize().val(e).trigger("change")},getPreviewTemplate:function(){a(g.preview);return a(g.preview)},createPreview:function(c,d,e,g,h){var i=f.getBlockContent(c),j=b.getPreviewTemplate(),k=f.data(c);k.url=d,k.name=e,k.type=g,k.size=h,j.attr("id",k.uid),b.fileName.inside(j).text(k.name).editable(!0),b.fileType.inside(j).text(k.type);
var l=a.plupload2.formatSize(k.size);b.fileSize.inside(j).text(l),b.fileUrl.inside(j).attr("href",k.url).on("click",function(a){a.preventDefault()}),i.html(j),k.showicon||b.fileIcon.inside(j).addClass("hide"),k.showsize||b.fileSize.inside(j).parent("div").addClass("hide")},"{showIcon} change":function(a){var d=f.getBlockContent(h),e=f.data(h);e.showicon=1==a.val(),e.showicon?b.fileIcon.inside(d).removeClass("hide"):b.fileIcon.inside(d).addClass("hide")},"{showSize} change":function(a){var d=f.getBlockContent(h),e=f.data(h);
...
},"{placeholder} mediaUploaderError":function(){},"{self} mediaInfoDisplay":function(b,c,d,e){"file"==e.meta.type&&a(d).find("[data-file-url]").on("click",function(a){a.preventDefault()})},"{browseButton} mediaSelect":function(a,c,d){var g=f.block.of(a);if("file"==d.meta.type){var h=d.meta,i=e.document,j=i.isLegacy();j?(content=b.toLegacyHTML(g),i.insertContent(content)):b.createPreview(g,h.url,h.title,h.type,h.size)}},"{self} mediaInsert":function(a,c,d,g,h,i){if("file"==d.meta.type){var j=e.document,k=j.isLegacy();
if(k)content=b.toLegacyHTML(d.meta,g),j.insertContent(content);else{var g=f.constructBlock("file",{name:h.title,type:d.meta.extension,size:d.meta.size,url:d.meta.url,showicon:h.showicon,showsize:h.showsize});f.addBlock(g),i||f.activateBlock(g)}}}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/gallery",function(a){function g(a,b){var c=Math.pow(10,b);return Math.round(a*c)/c}function h(b){if(a.isNumeric(b))return b;var c=b.split(":");return c[0]/c[1]}function j(a,b){return g(1/h(a)*100,b||3)+"%"}var b=this,c="is-empty",d="view-selectratio",e="view-customratio",f=function(b){if(b=a.trim(b),/\:/.test(b)){var c=b.split(":");
return parseInt(c[0])+":"+parseInt(c[1])}return parseFloat(b)||0};EasyBlog.Controller("Composer.Blocks.Handlers.Gallery",{elements:["[data-eb-gallery-{items-fieldset|list|list-item-group|list-item|list-item-icon|list-item-title|list-item-primary-label|list-item-delete-button|list-item-primary-button}]","[data-eb-gallery-{size-fieldset|strategy-field|strategy-menu-item}]","[data-eb-gallery-{ratio-button|ratio-label|ratio-customize-button|ratio-cancel-button|ratio-use-custom-button|ratio-cancel-custom-button|ratio-selection|ratio-input}]"],defaultOptions:{"{galleryUploadPlaceholder}":".eb-gallery-upload-placeholder","{galleryContainer}":".eb-gallery","{galleryViewport}":".eb-gallery-viewport","{galleryItem}":".eb-gallery-item:not(.is-placeholder)","{galleryStage}":".eb-gallery-stage","{galleryNextButton}":".eb-gallery-next-button","{galleryPrevButton}":".eb-gallery-prev-button","{galleryMenu}":".eb-gallery-menu","{galleryMenuItem}":".eb-gallery-menu-item","{galleryImage}":".ebd-block[data-type=image]","{galleryItemPlaceholder}":".eb-gallery-item.is-placeholder","{galleryMenuItemPlaceholder}":".eb-gallery-menu-item.is-placeholder","{galleryBrowseButton}":"[data-eb-gallery-browse]"}},function(b,g,i,k,l,m,n,o,p){return{init:function(){l=b.blocks,k=l.composer,m=g.meta,n=a(),o=l.dimensions,mediaManager=EasyBlog.MediaManager,mediaUploader=mediaManager.uploader,p=l.getBlockHandler("image")
...
}),b.uploadedItems=d.itemsArray.length},toData:function(a){var b=l.data(a);b.itemsArray=[],b.itemsKeyArray=[];for(var c in b.items)b.items.hasOwnProperty(c)&&(b.itemsArray.push(b.items[c]),b.itemsKeyArray.push(c));return b},toText:function(){},toHTML:function(a){var c=a.clone(),d=b.deconstruct(c),e=l.getBlockContent(d);return e.html()},toLegacyHTML:function(b){var c=[];a.each(b,function(a,b){c.push(b.uri)});var d="[embed=gallery]"+JSON.stringify(c)+"[/embed]";return d},getGalleryItemTemplate:function(){return a(m.galleryItem)
},getGalleryMenuItemTemplate:function(b){var c=a(m.galleryMenuItem);return c.data("id",b),c},createGalleryListItem:function(){return a(m.galleryListItem)},createGalleryPlaceholder:function(){return a(m.galleryPlaceholder)},createGalleryImage:function(a,b){var c=l.data(a),d=b.uri,e=mediaManager.getVariation(d,"medium"),f=e.width,g=e.height,i=f/g,j={uri:d,url:e.url,key:e.key,mode:"advanced",mode_lock:!0,fluid:!0,width:"100%",width_lock:!0,height:"100%",height_lock:!0,ratio:h(c.ratio),strategy:c.strategy,element_ratio:i,natural_width:f,natural_height:g,natural_ratio:i,caption_enabled:!1,link_enabled:!1,style_enabled:!1,popup_enabled:!1,variation:"large"},k=l.constructNestedBlock("image",j).addClass("is-isolated");
return k},"{galleryUploadPlaceholder} mediaUploaderFilesAdded":function(d,e,f,g){var h=l.block.of(d),i=b.galleryContainer.inside(h),j=b.galleryItemPlaceholder.inside(h),k=b.galleryMenuItemPlaceholder.inside(h);a.each(g,function(d,e){var f=e.id,g=a.uid("g"),l=b.getGalleryItemTemplate();l.attr("data-file-id",f).attr("data-id",g);var m=b.createGalleryPlaceholder();l.html(m),l.insertBefore(j),b.galleryMenuItem.inside(h).removeClass("active");var n=b.getGalleryMenuItemTemplate(g);n.attr("data-id",g).insertBefore(k).addClass("active"),mediaUploader.addItem(e,m),i.removeClass(c)
}),EasyBlog.ImageGallery.setLayout(i)},uploadedItems:0,"{galleryUploadPlaceholder} mediaUploaderFileUploaded":function(a,c,d,e,f){void 0===p&&(p=l.getBlockHandler("image"));var g=e.id,h=f.response,i=h.media,j=i.meta,k=l.block.of(a),f=l.data(k);setTimeout(function(){var a=b.galleryItem().where("fileId",g).removeAttr("data-file-id"),c=a.attr("data-id");mediaUploader.removeItem(e,a);var d=b.createGalleryImage(k,j);a.html(d);var h=j.uri,i=mediaManager.getVariation(h,"icon");f.items[c]={title:j.title,iconUrl:i.url},p.normalizeImageSize(d),k.is(n)&&b.populateList(k),0==b.uploadedItems&&b.setPrimary(c),b.uploadedItems+=1
},600)},setPrimary:function(a){var c=b.galleryItem().where("id",a),d=b.galleryMenuItem().where("id",a),e=l.block.of(c),f=l.data(e);f.primary=a,b.populateList(e),b.galleryMenuItem.inside(e).removeClass("active"),d.addClass("active")},setRatio:function(c,d){var e=l.data(c);e.ratio=d;var f=b.galleryStage.inside(c);f.css("padding-top",j(d));var g=b.galleryImage.inside(c);g.each(function(){var b=a(this);p.setImageRatio(b,h(d))})},updateRatio:function(a,c){b.setRatio(a,c),b.populateRatio(a)},populateRatio:function(a){var c=l.data(a),d=c.ratio;
...
},"{title} keyup":a.debounce(function(a){var d=f.data(h),e=f.getBlockContent(h),g=a.val();d.title=g;var i=g.length>0?" - "+g:"";b.spanTitle.inside(e).text(i)},250),"{alt} keyup":a.debounce(function(a){var d=f.data(h),e=f.getBlockContent(h),g=a.val();d.alt=g;var i=g.length>0?" - "+g:"";b.spanAlt.inside(e).text(i)},250)}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/pdf",function(a){var b=this;EasyBlog.require().script("composer/vendors/redactor10","composer/document/overlay","composer/vendors/selectionchange").done(function(){EasyBlog.Controller("Composer.Blocks.Handlers.Pdf",{defaultOptions:{"{browseButton}":".eb-composer-placeholder-file [data-eb-mm-browse-button]","{fileError}":"[data-eb-file-error]","{placeholder}":"[data-eb-composer-pdf-placeholder]","{player}":"[data-file-preview]","{dropElement}":"[data-plupload-drop-element]","{height}":"[data-pdf-height]","{wrapper}":"> [data-pdf-previewer]","{object}":"object","{iframe}":"iframe",width:"100%",height:"450px"}},function(b,c,d,e,f,g,h,i){return{init:function(){f=b.blocks,e=f.composer,g=c.meta,h=a(),i=EasyBlog.MediaManager
},toData:function(a){var b=f.data(a);return b},toText:function(a){var b=f.data(a);return b.url},toHTML:function(a){var c=(f.data(a),a.data("overlay"));return c?c.element().html():void 0},toLegacyShortcode:function(a,b){var c={uri:a.uri,height:b.height},d="[pdf]"+JSON.stringify(c)+"[/pdf]";return d},toEditableHTML:function(){return""},activate:function(a){h=a,b.populate(a)},deactivate:function(){},construct:function(b){var c=f.createBlockContainer("pdf"),b=a.extend(f.data(c),b);return c},constructFromMediaFile:function(a){{var c=a.data("key"),d=i.getUri(c),e=f.createBlockContainer("file");
f.getBlockContent(e),f.data(e)}return e.addClass("is-loading"),i.getMedia(d).done(function(a){var c=a.meta;b.createPreview(e,c.url,c.title,c.extension,c.size)}).fail(function(){}).always(function(){e.removeClass("is-loading")}),e},reconstruct:function(a){var c=f.data(a),d=a.data("overlay"),e=f.getBlockContent(a);c.url&&!d?(e.html(g.html),b.createEmbedObject(a)):e.html(g.html);var h=b.placeholder.inside(a),i=b.dropElement.inside(h);i.length>0&&EasyBlog.MediaManager.uploader.register(h)},deconstruct:function(){},refocus:function(){},reset:function(){},populate:function(a){f.data(a);
...
},"{placeholder} mediaUploaderError":function(){},"{browseButton} mediaSelect":function(a,c,d){var g=f.block.of(a);if("pdf"==d.meta.type){var h=d.meta,i=e.document,j=i.isLegacy();j?(content=b.toLegacyShortcode(g),content=b.toLegacyHTML(g),i.insertContent(content)):b.createPreview(g,h.url,h.title,h.type,h.size)}},"{self} mediaInsert":function(a,c,d,g,h,i){if("pdf"==d.meta.type){var j=e.document,k=j.isLegacy();if(k)content=b.toLegacyShortcode(d.meta,h),j.insertContent(content);else{if(h.previewer)var g=f.constructBlock("pdf",{name:h.title,url:d.meta.url,height:h.height});
else var g=f.constructBlock("file",{name:h.title,type:d.meta.extension,size:d.meta.size,url:d.meta.url,showicon:!0,showsize:!0});f.addBlock(g),i||f.activateBlock(g)}}}}}),b.resolve()})}),EasyBlog.module("composer/blocks/handlers/pinterest",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Handlers.Pinterest",{defaultOptions:a.extend({"{form}":"> [data-pinterest-form]","{insert}":"[data-pinterest-insert]","{source}":"[data-pinterest-source]","{loader}":"> [data-pinterest-loader]","{preview}":"> [data-pinterest-preview]","{errorMessage}":"[data-pinterest-error]","{fsSource}":"[data-fs-pinterest-source]","{fsUpdate}":"[data-fs-pinterest-update]"},EBD.selectors)},function(b,c,d,e,f,g,h){return{init:function(){f=b.blocks,e=f.composer,g=c.meta,h=a()
...
},activate:function(a){h=a,b.populate(a)},deactivate:function(){},construct:function(b){var b=a.extend({},c.data,b);return content},reconstruct:function(){},"{self} composerBlockDuplicate":function(c,d,e,g){var h=f.getBlockType(e);if("tabs"==h){f.updateBlockUid(e);var i=f.data(g);data=f.data(e),a.extend(data,i),f.duplicateChildBlocksData(e,g),clonedContent=f.getBlockContent(e);var j=b.tabHeaderListItem.inside(e).find("a");a.each(j,function(b){var d=a(j[b]).attr("href"),e=a.uid("tab-");a(j[b]).attr("href","#"+e),clonedContent.find("div"+d).attr("id",e)
})}},deconstruct:function(c){return a.each(c.find("[data-tab-wrapper]"),function(d,e){e=a(e);var f=e.parent();f.removeAttr("contenteditable"),e.children().appendTo(f),e.remove(),b.tabHeaderListItemContent.inside(c).eq(d).removeAttr("contenteditable")}),c},refocus:function(a){var c=b.tabPane.inside(a).filter(".active");c.focus()},reset:function(){},recover:function(){},populate:function(a){var c=f.data(a);b.control().listbox().listbox("populate",c.tabs,function(a,b){a.listboxitem("content",b)})},revert:function(){},toHTML:function(a){var c=a.clone(),d=b.deconstruct(c),e=f.getBlockContent(d);
return e.html()},toData:function(a){var b=f.data(a);return b},toText:function(a){var c=a.clone();return b.deconstruct(c).text()},tab:{create:function(){var d=a.uid("tab-"),e='<li><a href="#'+d+'" role="tab" data-bp-toggle="tab" data-tab-title contenteditable="true"></a></li>',g=a("<div></div>",{"class":"tab-pane",id:d}),i=a("<div></div>",{"class":"ebd-nest","data-type":"block","data-tab-wrapper":""}),j=f.constructNestedBlock("text");i.wrapInner(j),g.wrapInner(i),b.tabContent.inside(h).append(g),b.tabHeader.inside(h).append(e)
},remove:function(a){b.tabPane.inside(h).eq(a).remove(),b.tabHeaderListItem.inside(h).eq(a).remove()},focus:function(a){b.tabHeaderListItem.inside(h).eq(a).find("a").tab("show")}},"{tabHeaderListItem} click":function(a){a.find("a").tab("show")},"{tabHeaderListItemContent} keyup":a.debounce(function(a,c){var d=c.keyCode?c.keyCode:c.which;if("13"!=d){var e=a.parents(".nav-tabs > li").index(),g=a.html().replace(/(<br>\s*)+$/,"");b.control().listbox("getItems").eq(e).listboxitem("content",g),f.data(h).tabs[e].content=g
}},250),"{tabHeaderListItemContent} click":function(a,b){b.preventDefault()},"{tabHeaderListItemContent} keydown":function(a,b){var c=b.keyCode?b.keyCode:b.which;"13"==c&&b.preventDefault()},"{control} listboxBeforeAddItem":function(a,c,d){b.tab.create();var e=d.listboxitem("toData");b.tabHeaderListItem.inside(h).filter(":last").find("a").html(e.content)},"{control} listboxAfterAddItem":function(){f.data(h).tabs=b.control().listbox("toData"),1==b.tabContent.inside(h).length&&b.tabHeaderListItem.inside(h).filter(":first").find("a").tab("show")
...
if("video"==f){d.removeAttr("data-uid"),l.setBlockUid(d);var g=l.data(e);data=l.data(d),a.extend(data,g),data.uid=a.uid("video-");var h=l.getBlockContent(d);h.empty()}},createPlayer:function(c,d){var e=l.data(c),f=e.uid||(e.uid=a.uid("video-")),g=a(n.player).clone(),h=b.videoPlayer.inside(g),i=b.videoSource.inside(g);h.attr("id",f),i.attr("src",d),e.url=d,e.width&&g.css("width",e.width),e.height&&g.css("height",e.height),q.toFluidWidth(c),q.toFluidHeight(c);var j=l.getBlockContent(c);j.empty(),j.append(g),videojs(f,{controls:!0,autoplay:!1},function(){this.muted(e.muted)
})},populateVideoControls:function(a){var c=l.data(a),d=1==c.autoplay?1:0,e=1==c.loop?1:0,f=1==c.muted?1:0;b.autoplay().val(d).trigger("change"),b.loop().val(e).trigger("change"),b.muted().val(f).trigger("change")},"{muted} change":function(a){var c=l.data(o);c.muted=a.val()},"{autoplay} change":function(a){var c=l.data(o);c.autoplay=a.val()},"{loop} change":function(a){var c=l.data(o);c.loop=a.val()},populateVideoSize:function(a,c){for(var d,c=c||["width","height"];d=c.shift();){var e="width"==d?b.getVideoWidth(a):b.getVideoHeight(a),f=parseFloat(e),g=h(e);
if(console.log(e),b.resizingFromSlider!==d){if("px"==g)var i={start:f,step:1,range:{min:1,max:1600},pips:{mode:"values",values:[64,320,640,960,1280,1600],density:4}};if("%"==g)var i={start:f,step:1,range:{min:1,max:100},pips:{mode:"values",values:[0,20,40,60,80,100],density:5}};b.numsliderWidget.of(d).find(".noUi-pips").remove().end().noUiSlider(i,!0).noUiSlider_pips(i.pips)}var j=Math.round(f);"width"==d&&b.width().val(j),"height"==d&&b.height().val(j)}b.populateVideoRatio(a),b.populateVideoAlignment(a)},getVideoWidth:function(a){var b=p(a),c=b[0].style;
if(l.isNestedBlock(a)){var d=a[0].style.width;if(/%/.test(d))return d}return c.width||b.css("width")},getVideoHeight:function(a){var b=p(a),c=b[0].style;return c.height||b.css("height")},getVideoSize:function(a,c){return"width"==c?b.getVideoWidth(a):"height"==c?b.getVideoHeight(a):void 0},getVideoComputedWidth:function(a){return p(a).width()},getVideoComputedHeight:function(a){return p(a).outerHeight()},setVideoWidth:function(a,c){{var d=p(a),f=(getVideoViewport(a),b.getVideoRatio(a)),g=h(c);b.getVideoComputedHeight(a)
}d.toggleClass("is-responsive","%"==g),l.isNestedBlock(a)?("%"==g&&(a.css("width",c),d.css("width","")),"px"==g&&(a.css("width","auto"),d.css("width",c))):d.css("width",c),0==f&&"%"==g&&(f=null),b.adjustVideoRatio(a,f)},setVideoFluidWidth:function(a,b){var c=p(a);if(l.isNestedBlock(a))q.toAutoWidth(a),c.css("width",b),q.toFluidWidth(a),c.css("width","");else{var d=l.getBlockContent(a),b=b/d.width()*100+"%";c.css("width",b)}},setVideoSize:function(a,c,d){"width"==c&&b.setVideoWidth(a,d),"height"==c&&b.setVideoHeight(a,d)
},updateVideoSize:function(a,c,d){b.setVideoSize(a,c,d),b.populateVideoSize(a)},setVideoHeight:function(a,c){var d=p(a),e=getVideoViewport(a),f=b.getVideoRatio(a);if(b.isFluidVideo(a)){if(0==f){var g=b.getVideoComputedWidth(a),c=parseFloat(c);f=g/c}else{var g=parseFloat(c)*f;b.setVideoFluidWidth(a,g)}d.css("height",""),e.css("padding-top",ratioPadding(f))}else if(d.css("height",c),0!==f){var g=parseFloat(c)*ratioDecimal(f);d.css("width",g),e.css("padding-top","")}},setVideoUnit:function(a,c,d){if("width"===c){{var f=(p(a),b.getVideoWidth(a)),g=b.getVideoComputedWidth(a);
b.getVideoComputedHeight(a)}"px"==d&&/%/.test(f)&&b.setVideoWidth(a,g),"%"==d&&/px/.test(f)&&b.setVideoFluidWidth(a,g)}},getVideoUnit:function(a,c){var d=b.getVideoSize(a,c);return h(d)},updateVideoUnit:function(a,c,d){b.setVideoUnit(a,c,d),b.populateVideoSize(a)},handleNumsliderWidget:function(a,c){var d=b.getVideoSizeProp(a),e=b.getVideoSizeUnit(d),c=Math.round(c)+e;b.resizingFromSlider=d,b.updateVideoSize(o,d,c),b.resizingFromSlider=null},"{width} change":function(a){var d=a.val()+"%";b.updateVideoSize(o,"width",d)
},"{height} change":function(a){var d=a.val()+"px";b.updateVideoSize(o,"height",d)},"{numsliderWidget} nouislide":function(a,c,d){b.handleNumsliderWidget(a,d)},"{numsliderWidget} set":function(a,c,d){b.handleNumsliderWidget(a,d)},"{numsliderInput} input":function(c){function d(a){c.on("blur.numslider",function(){c.val(a)})}c.off("blur.numslider");var e=b.getVideoSizeProp(c),f=b.getVideoSize(o,e),g=parseFloat(f),i=c.val(),j=h(f),k=i+j;return a.isNumeric(i)?(b.updateVideoSize(o,e,k),void 0):d(g)},"{numsliderUnit} click":function(a){var c=b.getVideoSizeProp(a),d=a.data("unit");
b.updateVideoUnit(o,c,d)},"{self} composerBlockResizeStart":function(a,c,d){if("video"===l.getBlockType(d)){var f=b.getVideoComputedWidth(d),g=b.getVideoComputedHeight(d);d.data("initialWidth",f),d.data("initialHeight",g)}},"{self} composerBlockBeforeResize":function(a,c,d,e){function q(){b.isFluidVideo(d)?b.setVideoFluidWidth(d,n):b.setVideoWidth(d,n)}function r(){b.setVideoHeight(d,o)}if("video"===l.getBlockType(d)&&b.hasVideoContainer(d)){c.preventDefault();var g=(d.data("initialImageSize"),e.originalSize),h=e.size,i=h.width-g.width,j=h.height-g.height,k=d.data("initialWidth"),m=d.data("initialHeight"),n=k+i,o=m+j,p=b.getVideoRatio(d);
0==p?(0!==i&&q(),0!==j&&r()):0==i?0!==j&&r():q(),b.populateVideoSize(d)}},setVideoRatio:function(a,c){var d=l.data(a);d.ratio=c,b.adjustVideoRatio(a,c)},adjustVideoRatio:function(a,c){var d=p(a),e=getVideoViewport(a),f=b.getVideoComputedWidth(a),g=b.getVideoComputedHeight(a),h="",i="";null==c&&(c=f/g),b.isFluidVideo(a)?i=ratioPadding(c):h=0==c?g:f/ratioDecimal(c),d.css("height",h),e.css("padding-top",i)},populateVideoRatio:function(a){var c=l.data(a),d=c.ratio;b.ratioButton().toggleClass("ratio-unlocked",0==d),b.ratioLabel().html(d)
},updateVideoRatio:function(a,c){b.setVideoRatio(a,c),b.populateVideoRatio(a)},getVideoRatio:function(a){{var c=l.data(a);p(a)}if(void 0===c.ratio){var e=b.getVideoComputedWidth(a),f=b.getVideoComputedHeight(a);c.ratio=e/f}return j(c.ratio)},"{browseButton} mediaSelect":function(a,c,d){var f=l.block.of(a);if("video"==d.meta.type){var g=d.meta,h=k.document,i=h.isLegacy();i?(content=b.toLegacyHTML(f),h.insertContent(content)):b.createPlayer(f,g.url)}},"{self} mediaInsert":function(c,d,e,f,g,h){if("video"==e.meta.type){var i=k.document,j=i.isLegacy();
if(j){var m=l.data(f);g=a.extend(m,g),content=b.toLegacyShortcode(e.meta,f),i.insertContent(content)}else{var f=l.constructBlock("video",{url:e.meta.url,autoplay:g.autoplay,loop:g.loop,muted:g.muted});l.addBlock(f),h||l.activateBlock(f)}}},"{self} mediaInfoDestroy":function(a,c,d,e){if(!e||"video"==e.meta.type){var f=b.videoPlayer.inside(d),g=f.attr("id");videojs(g).dispose()}},"{ratioButton} click":function(){b.sizeField().switchClass(c)},"{ratioCustomizeButton} click":function(){b.sizeField().switchClass(d)
},"{ratioCancelButton} click":function(){b.sizeField().removeClass(c)},"{ratioCancelCustomButton} click":function(){b.sizeField().switchClass(c)},"{ratioOkCustomButton} click":function(){b.sizeField().removeClass(d)},"{ratioUseCustomButton} click":function(){var c=b.ratioInput(),e=m(c.val());0!=e&&(b.updateVideoRatio(o,e),b.ratioSelection().removeClass("active"),b.sizeField().removeClass(d))},"{ratioSelection} click":function(a){b.ratioSelection().removeClass("active"),a.addClass("active"),b.sizeField().removeClass(c);
var d=a.data("value");b.updateVideoRatio(o,d)},"{alignmentSelection} change":function(a){var b=a.val();l.font.setFontFormatting(o,"align"+b)},populateVideoAlignment:function(a){if(l.isNestedBlock(a))return b.sizeField().addClass("no-alignment"),void 0;var c=l.getBlockContent(a),d=b.getVideoComputedWidth(a),e=d<c.width();b.sizeField().toggleClass("no-alignment",!e);var f=a.css("text-align");b.alignmentSelection().val(f)},getVideoSizeField:function(c){var d=b["videoSizeFieldVideo"+a.capitalize(c)]();return d},getVideoSizeProp:function(a){var c=a.closest(b.numslider.selector),d=g(c.data("name"));
return d},getVideoSizeUnit:function(c){var d=b.getVideoSizeField(c);return a.trim(b.numsliderCurrentUnit.under(d).text())},isFluidVideo:function(a){var b=p(a);return b.hasClass("is-responsive")},hasVideo:function(a){var b=l.data(a);return!!b.url},hasVideoContainer:function(a){return b.videoContainer.inside(a).length>0}}}),b.resolve()})}),EasyBlog.module("composer/blocks/handlers/vimeo",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Handlers.Vimeo",{elements:["[data-vimeo-fieldset-{url|fluid|width-fieldset|height-fieldset|width|height|update-url}]"],defaultOptions:a.extend({"{form}":"> [data-vimeo-form]","{insert}":"[data-vimeo-insert]","{source}":"[data-vimeo-source]","{loader}":"> [data-vimeo-loader]","{player}":"iframe","{wrapper}":"[data-vimeo-wrapper]"},EBD.selectors)},function(b,c,d,e,f,g,h){return{init:function(){f=b.blocks,e=f.composer,g=c.meta,h=a()
},toData:function(a){var c=f.data(a),d=a.data("overlay");if(!d)return c;var e=b.player.inside(d.element());return c.source=e.attr("src"),c},toText:function(a){var b=f.data(a);return b.source},toHTML:function(a){var b=a.clone(),d=(f.data(b),a.data("overlay"));return d?d.element().html():void 0},activate:function(a){f.getBlockContent(a),f.data(a);h=a,b.populate(a)},deactivate:function(){},construct:function(){},getWrapper:function(){var c=a(g.wrapper);return c},reconstruct:function(a){var c=f.data(a),d=a.data("overlay"),e=f.getBlockContent(a);
c.source&&!d?b.setOverlay(a):0==c.source.length&&c.url?(e.html(g.html),b.crawl(c.url,a)):e.html(g.html),a.find(b.source.selector).off("paste").on("paste",function(a){a.stopPropagation()})},deconstruct:function(){},refocus:function(){},reset:function(){},populate:function(a){f.data(a);b.updateFieldset(a)},updateFieldset:function(a){var c=f.data(a);c.url&&(b.url().val(c.url),b.width().val(c.width),b.height().val(c.height),b.fluid().val(c.fluid?"1":"0").trigger("change"))},getOverlay:function(a){var c=a.data("overlay"),g=(f.data(a),f.getBlockContent(a));
if(!c){c=e.document.overlay.create(a);var h=b.getWrapper();c.placeholder().appendTo(h),g.empty().append(h),c.attach()}return c},setWrapperLayout:function(a){var c=b.wrapper.inside(a),d=f.data(a);d.fluid?c.addClass("is-responsive").css({width:"",height:""}):(c.hasClass("is-responsive")&&(d.width=c.width(),d.height=c.outerHeight()),b.width().val(d.width),b.height().val(d.height),c.css({width:d.width,height:d.height}).removeClass("is-responsive"))},setOverlay:function(a){var c=f.data(a),d=b.getOverlay(a);d.element().length>0&&d.element().empty(),b.setWrapperLayout(a),d.element().append(c.embed),d.refresh(),a.data("overlay",d)
...
}}},populateFontColor:function(){if(b.lastUpdatedViaFontColorUI)return b.lastUpdatedViaFontColorUI=!1,void 0;var c=g.selection.getParent(),d=a(c).css("color");b.colorpickerToggle().prop("checked",c.style.color),b.updateFontColorUI(d)},setFontColor:function(c){b.lastUpdatedViaFontColorUI=!0;var d=!1;a.browser.mozilla&&(d=!0),g.inline.toggleStyle("color: "+c,d),b.updateFontColorUI(c)},updateFontColorUI:function(a){b.updatingFontColorUI=!0,!a&&(a="#000"),b.fontColorCaption().css("backgroundColor",a),b.fontColorPicker().colorpicker("setColor",a),b.updatingFontColorUI=!1
...
b.fontFamilyCaption().html(d)},removeFontFamily:function(){b.lastUpdatedViaFontFamilyUI=!0,g.inline.removeStyleRule("font-family")},populateFontSize:function(){if(b.lastUpdatedViaFontSizeUI)return b.lastUpdatedViaFontSizeUI=!1,void 0;var c=g.selection.getParent(),d=a(c).css("fontSize"),e=!!c.style.fontSize;b.updateFontSizeUI(d),b.numsliderToggle().prop("checked",!!e)},setFontSize:function(c){if(a.isNumeric(c)){var d=b.getFontSizeUnit();c+=d}b.lastUpdatedViaFontSizeUI=!0,g.inline.format("span","style","font-size: "+c);
var e=g.selection.getParent(),f=a(e).css("fontSize");b.updateFontSizeUI(c||f),b.numsliderToggle().prop("checked",!!c)},updateFontSizeUI:function(a){b.updatingFontSizeUI=!0;var c=Math.abs(a.replace(/\%|px/gi,""));unit=a.match("%")?"%":"px",b.getFontSizeUnit()!==unit&&b.setFontSizeUnit(unit),b.fontSizeCaption().html(a),b.numsliderCurrentUnit().html(unit),b.numsliderUnit().removeClass("active").where("unit",'"'+unit+'"').addClass("active"),b.numsliderWidget().val(c),b.numsliderInput().val(c),b.updatingFontSizeUI=!1
},removeFontSize:function(){g.inline.removeStyleRule("font-size")},getFontSizeUnit:function(){return b.fontSizeContent().data("unit")||"%"},setFontSizeUnit:function(d){b.fontSizeContent().data("unit",d);var e=c.fontSizeUnits[d];b.numsliderWidget().find(".noUi-pips").remove().end().noUiSlider(a.extend({document:i},e),!0).noUiSlider_pips(e.pips)},formattingTags:{bold:"strong",italic:"em",underline:"u",strikethrough:"del",code:"code",superscript:"sup",subscript:"sub",orderedlist:"ol",unorderedlist:"ul"},populateFontFormatting:function(){b.lastUpdatedViaFontFormattingUI?b.lastUpdatedViaFontFormattingUI=!1:b.removeTextMarkers();
var c=g.selection.getCurrent(),d=a(c).parentsUntil(EBD.block).filter("ul, ol").eq(0);b.fontFormatOption().each(function(){var e=a(this),f=e.data("format"),g=b.formattingTags[f];hasFormatting=/unorderedlist|orderedlist/.test(f)?d.is(g):0!==a(c).closest(g).length,e.toggleClass("active",hasFormatting)})},toggleFontFormatting:function(a){switch(a){case"orderedlist":case"unorderedlist":g.list.toggle(a);break;case"indent":g.indent.increase();break;case"outdent":g.indent.decrease();break;case"clear":b.selectWithinTextMarkers(),g.inline.removeFormat(),b.removeTextMarkers();
break;default:!b.hasTextMarkers()&&b.createTextMarkers(),g.inline.format(a),b.lastUpdatedViaFontFormattingUI=!0}},hasTextMarkers:function(){return b.workarea().find(".composer-text-marker").length>0},createTextMarkers:function(){g.selection.removeMarkers(),g.selection.createMarkers();var c=a.makeArray(b.workarea().find(".redactor-selection-marker").each(function(){a(this).removeClass("redactor-selection-marker").addClass("composer-text-marker").attr("id",this.id.replace("selection-","text-"))}));return b.selectWithinTextMarkers(c),c
},getTextMarkers:function(){var c=a.makeArray(b.workarea().find("span#text-marker-1, span#text-marker-2"));return c[0]&&c[1]?c:void 0},selectWithinTextMarkers:function(a){a||(a=b.getTextMarkers()),a&&g.caret.set(a[0].nextSibling,0,a[1],0)},removeTextMarkers:function(){b.workarea().find(".composer-text-marker").remove()},startEditingSelection:function(){k=!0,b.removeTextMarkers(),b.workarea().off("mousedown.stopEditingSelection").one("mousedown.stopEditingSelection",function(){b.stopEditingSelection()})},stopEditingSelection:function(){k=!1
},initLinks:function(){b.linkItem.template=b.linkItem(".is-blank").detach().removeClass("is-blank")[0]},populateLinks:function(){var c=g.selection.getNodesInRange(),d=a(c).filter("a"),e=b.linkItemGroup().empty();a.each(d,function(a,c){var d=b.createLinkItem().appendTo(e);b.processLinkItem(d),b.updateLinkItem(d,c)}),b.linkItemGroup().toggleClass("has-existing-links",d.length>0);var f=b.createLinkItem().addClass("is-new").appendTo(e);b.processLinkItem(f);var h=g.selection.getText();b.linkPreviewCaption.inside(f).html(h)
},createLinkItem:function(){var c=a(b.linkItem.template).clone();return c},processLinkItem:function(c){var d=b.linkUrlField.inside(c),e=b.linkTitleField.inside(c);c.data("linkUrlField",d[0]),c.data("linkTitleField",e[0]),d.data("linkItem",c).on("input",b.linkUrlFieldInputHandler).on("mousedown",function(){if(a.IE){var b=c.data("anchorNode");b||g.selection.save()}}),e.data("linkItem",c).on("input",b.linkTitleFieldInputHandler).on("mousedown",function(){if(a.IE){var b=c.data("anchorNode");b||g.selection.save()
...
var e=a(d).data("linkItem");b.updateAnchorNode(e)},"{linkBlankOptionField} click":function(a){var d=a.find("input");d.is(":checked")?d.prop("checked",!1):d.prop("checked",!0),b.startEditingSelection();var e=b.linkItem.of(a);b.updateAnchorNode(e)},"{linkRemoveButton} click":function(a){b.startEditingSelection();var d=b.linkItem.of(a);b.removeLinkItem(d)}}}),b.resolve()})}),EasyBlog.module("composer/blocks/toolbar",function(a){var b=this,c="is-editing-block",d="is-moving-block",e="is-dropping-block",f="is-duplicating-block";
EasyBlog.Controller("Composer.Blocks.Toolbar",{elements:["[data-eb-blocks-{close-button|parent-button|cancel-move-button}]","[data-ebd-block-{toolbar|sort-handle}]"],defaultOptions:a.extend({"{cancelDropButton}":"[data-blocks-cancel-drop-button]","{cancelMoveButton}":"[data-blocks-cancel-move]","{closeBlocks}":"[data-toolbar-blocks-close]","{toolbarWrapper}":"[data-toolbar-blocks-wrapper]","{done}":"[data-blocks-done]","{move}":"[data-blocks-move]","{duplicate}":"[data-blocks-duplicate]","{remove}":"[data-blocks-remove]"},EBD.selectors)},function(b,g,h,i,j){return{init:function(){j=b.blocks,i=b.blocks.composer
},dropping:!1,cancelDrop:function(){i.blocks.droppable.selectedMenu=null,i.blocks.droppable.selectedBlock=null,i.blocks.droppable.dropStop(),i.manager().removeClass(e)},"{closeBlocks} click":function(){i.views.hide("blocks"),b.toolbarWrapper().removeClass("open")},"{self} composerBlockDrop":function(){b.dropping=!1,i.manager().removeClass(f)},"{self} composerBlockMenuSelected":function(){b.dropping=!0},"{self} click":function(c,d){var e=a(d.target);if(!(!b.dropping||e.is("[data-toolbar-blocks]")||e.parents("[data-eb-composer-blocks]").length>0)){var f=e.parents("[data-ebd-dropzone]").length>0;
f||b.cancelDrop()}},"{self} composerBlockActivate":function(a,b,d){d.hasClass("is-standalone")||i.manager().addClass(c)},"{self} composerBlockDeactivate":function(){i.manager().removeClass(c)},"{cancelMoveButton} click":function(){i.manager().removeClass(d),i.blocks.droppable.dropStop();var b=j.getCurrentBlock();b.removeClass("hide").removeClass("is-sort-item")},"{parentButton} click":function(){var b=j.getCurrentBlock();if(b.length){var c=j.getParentBlock(b);c.length?j.activateBlock(c):j.deactivateBlock()}},"{cancelDropButton} click":function(a,c){c.stopPropagation(),b.cancelDrop()
},"{closeButton} click":function(){i.views.hide("blocks")},"{duplicate} click":function(){var d=j.getCurrentBlock(),e=j.getBlockContent(d),g=j.getBlockType(d),h=j.getData(d),k=j.createBlock(g);j.data(k,h),j.setBlockContent(k,e),i.blocks.droppable.populateDropzones(),i.manager().addClass(f),b.trigger("composerBlockDuplicate",[k,d])},"{move} click":function(){i.blocks.droppable.populateDropzones(),i.manager().addClass(d);var c=j.getCurrentBlock();c.addClass("hide").addClass("is-sort-item"),b.trigger("composerBlockMove",[c])
},"{remove} click":function(){var c=j.getCurrentBlock();j.removeBlock(c),i.manager().removeClass("is-editing-block")}}}),b.resolve()}),EasyBlog.module("composer/blocks/tree",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Tree",{elements:["[data-eb-{block|block-icon|block-title|block-level-count|block-child-count}]","[data-eb-blocks-{tree-field|tree|tree-item|tree-item-template|tree-item-icon|tree-item-title|tree-item-group|tree-toggle-button}]"]},function(b,c,d,e,f,g){return{init:function(){f=b.blocks,e=f.composer,g=b.createTreeItem,b.treeItemTemplate=b.treeItemTemplate().detach().html()
...
}).fail(function(){b.trigger("composerSaveError")}).always(function(){b.saving=!1,c.target&&(c.target=void 0),c.preview&&(c.preview=!1)})}},trash:function(){EasyBlog.ajax("site/views/composer/delete",{uid:b.getPostUid()}).done(function(){})},setMessage:function(c){a.isArray(c)||(c=[c]);var d=c[0],e="success";/error|danger/.test(d.type)&&(e="danger"),b.alert().removeClass("t-hidden"),b.alert().removeClass("o-alert--success o-alert--danger").addClass("o-alert--"+e),b.alert().find(b.alertMessage).html(d.message)
...
},"{exit} click":function(a){c.exitAlert||b.disableLeavePrompt(),window.location=a.data("url")},"{saveDraft} click":function(){b.disableLeavePrompt();var d=b.publishedField().val();d!=f&&b.publishedField().val(e),b.save({preview:!1,target:!1,autosave:!1,isapply:!1})},"{savePostButton} click":function(a){var c=b.publishedField().val();c!=f&&b.publishedField().val(e),a.addClass("is-saving"),b.save({autosave:1,isapply:0}).done(function(){}).always(function(){a.removeClass("is-saving")})},"{submitApproval} click":function(){b.disableLeavePrompt(),b.publishedField().val(f),b.save({autosave:0,isapply:0})
},"{approvePost} click":function(a){b.publishedField().val(g),a.addClass("is-saving"),b.disableLeavePrompt(),b.save({autosave:0,isapply:0}).done(function(){}).always(function(){a.removeClass("is-saving")})},"{rejectPost} click":function(){b.publishedField().val(e),b.disableLeavePrompt(),b.save({autosave:0,isapply:0}).done(function(){})},"{publish} click":function(){b.previewField().val(0),b.publishedField().val(g),b.disableLeavePrompt(),b.save({autosave:0,isapply:0})},"{updatePost} click":function(){b.publishedField().val()==e&&(b.previewField().val(0),b.publishedField().val(g)),b.disableLeavePrompt(),b.save()
},"{unpublishPostButton} click":function(){b.publishedField().val(i),b.save({autosave:0,isapply:0})},"{trashPost} click":function(){b.trash()},"{draftDiscard} click":function(){EasyBlog.ajax("site/views/composer/discardDraft",{id:b.getPostId()}).done(function(a){b.setMessage({type:"success",message:a}),j.removeClass("warning-draft"),b.draftItems().remove()}).fail(function(a){b.setMessage(a)})},"{self} composerSelectTemplate":function(){j.removeClass("show-templates"),setTimeout(function(){b.autosave.start()},6e3)
},"{permalinkPreview} click":function(){if(b.isDraft())return b.preview().click(),void 0;if(b.isPublished()){window.open(c.permalink,b.getPreviewNamespace())}else console.log(b.isDraft())},disableLeavePrompt:function(){a(window).off("beforeunload"),a(window).unbind("beforeunload"),window.onbeforeunload=function(){}}}}),a("body").addController("EasyBlog.Controller.Composer"),b.resolve()})}),EasyBlog.module("composer/document",function(){var b=this;EasyBlog.require().script("composer/document/toolbar","composer/document/permalink","composer/document/location","composer/document/cover","composer/vendors/expanding").done(function(a){EasyBlog.Controller("Composer.Document",{hostname:"document",pluginExtendsInstance:!0,elements:["[data-eb-composer-document] .eb-composer-{viewport|viewport-content}","[data-eb-composer-{page|page-viewport|page-header|page-body}]","[data-ebd-{workarea|textarea}]","[data-ebd-workarea-{ghosts}]","[data-ebd-workarea-{legacy}]"],defaultOptions:{"{root}":"[data-ebd-workarea] "+EBD.root,"{block}":EBD.block,"{nest}":EBD.nest,"{titleField}":"[data-post-title]",plugins:["toolbar","permalink","location","cover"]}},function(b,c,d,e,f,g){return{init:function(){g=b.composer,b.initPlugins(),b.initTitlebar(),b.isLegacy()?b.initLegacyDocument():b.initEasyBlogDocument()
},initPlugins:function(){a.each(c.plugins,function(a,c){b.addPlugin(c)})},initTitlebar:function(){var a=b.titleField().one("focus",function(){a.expandingTextarea()})},initLegacyDocument:function(){if(window.tinyMCE){var c=function(){if(tinyMCE.activeEditor){var d=tinyMCE.activeEditor.editorContainer;a.isString(d)||(d.style.width="100%",a(tinyMCE.activeEditor.contentDocument).find("html").css({height:"100%"}).end().find("body").css({height:"100%",margin:"1em"})),b.setLayout()}else setTimeout(c,500)};c()}b.trigger("composerDocumentReady")
},initEasyBlogDocument:function(){EasyBlog.require().script("composer/vendors/redactor10","composer/document/overlay","composer/vendors/selectionchange").done(function(){e=b.composer.editor=b.workarea().composer({replaceDivs:!1,toolbar:!1}).data("redactor"),f=b.composer.blocks,b.initDocument(),b.setLayout(),b.addPlugin("overlay"),b.initSelectionChange(),b.trigger("composerDocumentReady")})},isLegacy:function(){return"legacy"==g.getDoctype()},initDocument:function(){b.trigger("composerDocumentInit"),b.workarea().removeClass("is-loading")
...
},activate:function(){},deactivate:function(){},isActive:function(){},hideBlocks:function(){b.blocks().parent().removeClass("open")},"{toggleSidebar} click":function(){e.manager().toggleClass("is-sidebar-open")},"{media} click":function(a){b.hideBlocks(),EasyBlog.MediaManager.open(a.data("uri"))},"{closeDropdown} click":function(a,c){c.stopPropagation();var d=a.parents(b.button.selector),f=d.data("type");d.removeClass("open"),e.views.hide(f)},"{blocks} click":function(a){var c=a.parent().hasClass("open");return e.views.show("blocks"),c?(a.parent().removeClass("open"),void 0):(a.parent().addClass("open"),void 0)
...
},getFilename:function(a){var a=b.getUri(a),c=a.lastIndexOf("/");return c>-1?a.slice(c+1):a},isOpen:function(){return!b.frame().hasClass("t-hidden")},isRoot:function(a){return b.getUri(a).indexOf("/")<0},canInsert:function(){return b.frame().hasClass("has-insertions")},canDelete:function(){return b.frame().hasClass("can-delete")},canUpload:function(){return b.frame().hasClass("can-upload")},getCurrentPostUri:function(){return"post:"+EasyBlog.Composer.getPostId()},medias:{},mediaLoaders:{},getMedia:function(a){var c=b.getKey(a),d=b.mediaLoaders[a];
return d||(d=EasyBlog.ajax("site/views/mediamanager/info",{key:c}).done(function(a){var c=a.uri;b.setMedia(c,a)})),d},setMedia:function(c,d){b.medias[c]=d,b.mediaLoaders[c]=a.Deferred().resolve(d)},getVariations:function(a){var c=b.medias[a];if(c)return c.meta.variations||{}},getVariation:function(c,d){if(a.isString(d)){var e=d;switch(e){case"icon":d=["system/icon","system/small","system/small 320","system/thumbnail","system/original"];break;case"small":d=["system/small","system/small 320","system/thumbnail","system/original"];
...
},hide:function(){b.frame().find("[data-dragzone]").addClass("t-hidden")}},"{frame} dragover":function(){b.canUpload()&&b.dropzone.show()},"{frame} drop":function(){b.dropzone.hide()},"{frame} dragleave":function(){b.dropzone.hide()},"{selectionItem} click":function(a){var d=a.data("uri");b.panel.show(d)},simulateMetakey:!1,"{checkbox} click":function(a,c){c.preventDefault(),c.stopPropagation();var d=a.siblings(b.checkboxInput),e=a.parent(b.item);b.simulateMetakey=!0,d.prop("checked",!d.is(":checked")).trigger("change"),e.click()
},"{checkboxInput} change":function(){var d=b.checkboxInput(":checked").length;0==d&&(b.simulateMetakey=!1)},"{item} click":function(a,d){var e=!a.hasClass("is-selected"),f=a.data("uri");b.folder().removeClass("is-selected"),(d.metaKey||c.mobile)&&(b.simulateMetakey=!0),(!b.simulateMetakey&&!d.metaKey||"select"==b.mode&&"thumbnails"!=b.currentBrowseType&&"gallery"!=b.currentBrowseType)&&b.selection.clear(),a.toggleClass("is-selected",e),a.find(b.checkboxInput).prop("checked",e).trigger("change"),b.getMedia(f).done(function(a){var d=b.getKey(a.uri);
...
},"{mobileHidePanel} click":function(a,c){c.stopPropagation(),b.panel.hide(),b.frame().removeClass("is-info-panel-open")},"{insertGallery} click":function(){var d=b.selection.getItems();b.trigger("mediaInsertGallery",[d]),b.hide()},"{insert} click":function(){var e=b.selection.total()>1,f=b.selection.getItems();a.each(f,function(c){var f=b.getUri(c);b.getMedia(f).done(function(c){var d=a("<div>");d.html(c.info);var g=d.find(EBD.standaloneBlock);b.pauseVideoObject();var h=b.panel().data("uri");if(h==f&&(c.panel=b.panel().find("> div")),c.data=a(c.panel).find("[data-mm-form]").serializeObject(),a.map(c.data,function(a,b){0==a&&(c.data[b]=!1),1==a&&(c.data[b]=!0)
}),"image"==c.meta.type&&"lightbox"==c.data.link){var i=b.getVariation(c.data.uri,"original");c.data.popup_url=i.url,c.data.popup_uri=i.uri}"select"==b.mode?b.currentBrowseButton.trigger("mediaSelect",[c,c.data]):b.trigger("mediaInsert",[c,g,c.data,e])})}),b.hide()},"{layout} click":function(a){var d=a.data("type");b.layout().removeClass("is-active"),b.layout("[data-type="+d+"]").addClass("is-active"),b.listing().removeClass("is-grid is-list").addClass("is-"+d)},"{close} click":function(){b.hide()},"{breadcrumb} click":function(a){var d=a.data("uri"),e=a.nextAll();
e.remove(),b.navigate(d,!1)},"{item} mediaTitleChanged":function(a,b,c){var d=a.find("[data-item-title]");d.html(c)},"{self} keyup":function(a,c){27==c.keyCode&&b.isOpen()&&b.hide()},"{self} mediaUploaderFileFiltered":function(a,c,d,e){if(b.canUpload()){{var f=b.uploadItems[e.id]||b.createUploadItem(e);b.getType(e.name)}b.file.insert(f)}},"{self} mediaUploaderFileError":function(c,d,e,f){var g=f.file,h=a(b.uploadItems[g.id]),i=JSON.parse(f.response);h.addClass("is-failed");var j=h.find("[data-eb-mm-failed-message]");
j.attr("data-original-title",i.message),j.attr("data-eb-provide","tooltip")},"{self} mediaUploaderFileUploaded":function(c,d,e,f,g){var h=g.response,i=h.media;b.setMedia(i.uri,i),setTimeout(function(){var c=b.uploadItems[f.id];if(c){var d=a(i.file).addClass("is-new");a(c).replaceWith(d)}},600)},"{self} mediaSelectionUpdated":function(a,c,d,f){var g=b.selection.total();if(b.selectionCounter().html(g),0>=g)return b.actions().removeClass("show-insert show-gallery show-insert"),void 0;var h=e.document.isLegacy();
if("folder"!=f.meta.type||h){if("folder"==f.meta.type&&h)return b.actions().addClass("show-gallery"),void 0;g>=1&&b.actions().addClass("show-insert"),g>1&&b.selection.canCreateGallery()?b.actions().addClass("show-gallery"):b.actions().removeClass("show-gallery")}},"{browseButton} click":function(a){var d=a.data("eb-mm-filter"),e=a.data("eb-mm-start-uri"),f=b.getUri(e),g=a.data("eb-mm-browse-place"),h=a.data("eb-mm-browse-type");"post"==f&&(f=b.getCurrentPostUri()),b.mode="select",b.currentBrowseType=h,b.currentBrowseButton=a,b.currentBrowseButton.trigger("mediaSelectStart",[b.currentBrowseButton]),b.open(f,d),"local"==g?b.frame().addClass("show-local"):b.frame().removeClass("show-local")
...
},getTemplate:function(b){var d=a(c.templates[b]);return d},insertCategory:function(a){var c=b.getTemplate("primaryCategory");c.attr("data-title",a.title).attr("data-id",a.id).find(b.categoryText).html(a.title),b.assignPrimaryCategory(a.id,a.title),b.categories().append(c)},removeCategory:function(c){if(1!=b.categories().children().length){if(b.categories().children('[data-id="'+c.id+'"]').remove(),1==b.categories().children().length||c.id==b.primaryCategoryInput().val()){var d=a(b.categories().children()[0]),f=d.data("id"),g=d.data("title");
b.assignPrimaryCategory(f,g)}e.form().find("[data-category="+c.id+"]").remove()}},assignPrimaryCategory:function(a,c){b.primaryCategoryInput().val(a),b.primaryCategoryTitle().html(c);var d={id:a,title:c};b.trigger("categorysetprimary",d)},categoryExists:function(a){var a=b.categories().children('[data-id="'+a.id+'"]');return a.length>0},"{category} click":function(a){var d=a.data("id"),e=a.data("title");b.assignPrimaryCategory(d,e)},"{self} categorydeselect":function(a,c,d){var e=b.fieldsPanel().find('[data-category-id*="'+d.id+'"]');
if(groupId=e.data("group-id")){categoryIds=e.attr("data-category-id");var f=categoryIds.split(",");if(f.length>1)return f=jQuery.grep(f,function(a){return a!=d.id}),f&&(categoryIds=f.join()),e.attr("data-category-id",categoryIds),b.removeCategory(d),void 0}e.remove(),0==b.fieldsPanel().find("[data-panel-field]").length&&b.empty().show(),b.removeCategory(d)},"{self} categoryselect":function(a,c,d){b.categoryExists(d)||b.insertCategory(d),EasyBlog.ajax("site/views/categories/getCustomFields",{id:d.id,postId:EasyBlog.Composer.getPostId()}).done(function(a,c){if(a.length>0){if(c){var f=b.fieldsPanel().find('[data-group-id="'+c+'"]'),g=f.data("category-id");
if(g)return f.attr("data-category-id",g+","+d.id),void 0}var h=e.panels.panelTab.get("fields");h.removeClass("hide"),b.empty().hide(),b.fieldsPanelForm().append(a)}});var f=b.createHiddenInput(d);f.appendTo(e.form())},createHiddenInput:function(b){var c=a("<input>").attr("type","hidden").attr("value",b.id).attr("name","categories[]").attr("data-category",b.id);return c},"{self} composerSaveError":function(a,c,d){d.customCode&&-500==d.customCode?b.fieldsTab().addClass("has-error"):b.fieldsTab().removeClass("has-error")
...
}),m.getHash()&&m.Adapter.onDomLoad(function(){m.Adapter.trigger(a,"hashchange")})))},m.init()}(window);var c=[];a.fn.route=function(b){if(this.is("a")){var d=this.attr("title"),e=a.joomla.appendTitle;"before"===e&&(d=a.joomla.sitename+(d?" - "+d:"")),"after"===e&&(d=(d?d+" - ":"")+a.joomla.sitename);var f=(new Date).getTime();c[f]=f,History.pushState(a.extend({timestamp:f,refresh:!0},b),d,this.attr("href"))}return this},History.Adapter.bind(window,"statechange",function(){var a=History.getState();a.id===History.savedStates[0].id&&(window.location=a.url),a.data.timestamp in c?delete c[a.data.timestamp]:a.data.refresh&&(window.location=a.url)
...
}}},paste:function(){return{init:function(b){if(!a(b.target).is("input, textarea")&&this.opts.cleanOnPaste){this.rtePaste=!0,this.buffer.set(),this.selection.save();var c=b.originalEvent.clipboardData;if(c){var d=c.types,e="";a.indexOf(d,"text/html")>-1?e=c.getData("text/html"):a.indexOf(d,"text/plain")>-1&&(e=c.getData("text/plain")),this.selection.restore();var f=a("<div>").html(e);this.$editor.trigger("composerPaste",[f]),f.find("h1,h2,h3,h4,h5,h6,img,iframe").each(function(){a(this).replaceWith(a(this).text())
