	...
	<div class="horizontal-form">
		...
		<div class="tab-content">
			...
			<div class="tab-pane fade" id="global-params-pane" role="tabpanel">
				<?php
				JsnExtFwHtml::renderSettingsForm('jsnextfw', '#toolbar-apply .button-apply', null, 'config/framework.json');

				JsnExtFwHtml::renderSettingsForm($component, '#toolbar-apply .button-apply', null, JSNEXTFW_PATH . '/config/extension.json');
				?>
			</div>
		</div>
	</div>
