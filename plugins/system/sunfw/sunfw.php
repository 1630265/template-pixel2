...
class PlgSystemSunFw extends JPlugin
{
	...
	public function onAfterRender()
	{
		if (isset($this->renderExtraOptions) && $this->renderExtraOptions)
		{
			...
			$ajaxBase = JRoute::_(
				"index.php?option=com_ajax&format=json&group=system&plugin=sunfw&template_name={$this->renderExtraOptions->template}&style_id={$this->renderExtraOptions->id}&" .
