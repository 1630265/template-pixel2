...
class PlgSystemPageBuilder3 extends JPlugin
{
    ...
    public function onAfterInitialise()
    {
        ...
        if (!in_array($option, self::$unSupport)) {
            defined('PAGEFLY_VERSION') || define('PAGEFLY_VERSION', '1.2.9');
    ...
    public function onBeforeRender()
    {
        ...
        if (defined('JSNPB3_EDITOR_AVAILABLE') && defined('JSNPB3_EDITOR_SWITCHER_AVAILABLE')) {
            JSNMenuHelper::addEntry(
                'jsn-pb3-editor-switcher',   // Button ID.
        ...
        if ((defined('JSNPB3_EDITOR_AVAILABLE') || defined('JSNPB2_EDITOR_AVAILABLE')) &&  defined('JSNPB3_EDITOR_SWITCHER_AVAILABLE')) {
        ...
        // load edition checking
        if ((class_exists('JSNHtmlHelper') && method_exists('JSNHtmlHelper', 'loadEditionManager')) && ((defined('JSNPB3_EDITOR_AVAILABLE') && $active_editor == 'pagebuilder3') || $this->app->input->get('option') === 'com_pagebuilder3')) {
            JSNHtmlHelper::loadEditionManager('com_pagebuilder3', JUri::root() . '/plugins/system/pagebuilder3/assets/edition.js');
        }
...
//            throw new $e;
    ...
    protected static function renderPageBuilderContent(&$content)
    {
        ...
        if (false !== strpos($content, self::$start_html) && (false !== strpos($content, self::$end_data) || false !== strpos($content, self::$end_hash))) {
